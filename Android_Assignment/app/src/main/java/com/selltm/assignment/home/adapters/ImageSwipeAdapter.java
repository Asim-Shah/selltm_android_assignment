...
public class ImageSwipeAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ImageView prodImageView = item_view.findViewById(R.id.product_images);
//        Picasso.with(context).load(imageUrls[position]).resizeDimen(R.dimen.image_width, R.dimen.image_height).into(prodImageView);
        Picasso.with(context).load(R.drawable.image1).into(prodImageView);
